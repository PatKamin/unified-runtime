...
ur_result_t urPrintFunction(enum ur_function_t value, char *buff,
...
ur_result_t urPrintStructureType(enum ur_structure_type_t value, char *buff,
                                 const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintResult(enum ur_result_t value, char *buff,
                          const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintBaseDesc(const struct ur_base_desc_t params, char *buff,
                            const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintRectOffset(const struct ur_rect_offset_t params, char *buff,
                              const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintRectRegion(const struct ur_rect_region_t params, char *buff,
                              const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintDeviceInitFlags(enum ur_device_init_flag_t value, char *buff,
                                   const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintAdapterInfo(enum ur_adapter_info_t value, char *buff,
                               const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintAdapterBackend(enum ur_adapter_backend_t value, char *buff,
                                  const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintPlatformInfo(enum ur_platform_info_t value, char *buff,
                                const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintApiVersion(enum ur_api_version_t value, char *buff,
                              const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintPlatformNativeProperties(
    const struct ur_platform_native_properties_t params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintPlatformBackend(enum ur_platform_backend_t value, char *buff,
                                   const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintDeviceType(enum ur_device_type_t value, char *buff,
                              const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintDeviceInfo(enum ur_device_info_t value, char *buff,
                              const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintDevicePartition(enum ur_device_partition_t value, char *buff,
                                   const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintDevicePartitionProperty(
    const struct ur_device_partition_property_t params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintDevicePartitionProperties(
    const struct ur_device_partition_properties_t params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintDeviceUsmAccessCapabilityFlags(
    enum ur_device_usm_access_capability_flag_t value, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintContextFlags(enum ur_context_flag_t value, char *buff,
                                const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
urPrintContextProperties(const struct ur_context_properties_t params,
                         char *buff, const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintContextInfo(enum ur_context_info_t value, char *buff,
                               const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintContextNativeProperties(
    const struct ur_context_native_properties_t params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintMemFlags(enum ur_mem_flag_t value, char *buff,
                            const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintMemType(enum ur_mem_type_t value, char *buff,
                           const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintMemInfo(enum ur_mem_info_t value, char *buff,
                           const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintImageInfo(enum ur_image_info_t value, char *buff,
                             const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintImageDesc(const struct ur_image_desc_t params, char *buff,
                             const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintBufferChannelProperties(
    const struct ur_buffer_channel_properties_t params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintBufferAllocLocationProperties(
    const struct ur_buffer_alloc_location_properties_t params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintSamplerInfo(enum ur_sampler_info_t value, char *buff,
                               const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintSamplerNativeProperties(
    const struct ur_sampler_native_properties_t params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintUsmPoolFlags(enum ur_usm_pool_flag_t value, char *buff,
                                const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintUsmType(enum ur_usm_type_t value, char *buff,
                           const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintUsmAllocInfo(enum ur_usm_alloc_info_t value, char *buff,
                                const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintUsmAdviceFlags(enum ur_usm_advice_flag_t value, char *buff,
                                  const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintUsmDesc(const struct ur_usm_desc_t params, char *buff,
                           const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintUsmPoolInfo(enum ur_usm_pool_info_t value, char *buff,
                               const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintVirtualMemInfo(enum ur_virtual_mem_info_t value, char *buff,
                                  const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintProgramInfo(enum ur_program_info_t value, char *buff,
                               const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintSpecializationConstantInfo(
    const struct ur_specialization_constant_info_t params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintProgramNativeProperties(
    const struct ur_program_native_properties_t params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintKernelArgValueProperties(
    const struct ur_kernel_arg_value_properties_t params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintKernelArgLocalProperties(
    const struct ur_kernel_arg_local_properties_t params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintKernelInfo(enum ur_kernel_info_t value, char *buff,
                              const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintKernelExecInfo(enum ur_kernel_exec_info_t value, char *buff,
                                  const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintKernelArgPointerProperties(
    const struct ur_kernel_arg_pointer_properties_t params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintKernelExecInfoProperties(
    const struct ur_kernel_exec_info_properties_t params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintKernelArgSamplerProperties(
    const struct ur_kernel_arg_sampler_properties_t params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintKernelArgMemObjProperties(
    const struct ur_kernel_arg_mem_obj_properties_t params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintQueueInfo(enum ur_queue_info_t value, char *buff,
                             const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintQueueFlags(enum ur_queue_flag_t value, char *buff,
                              const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintCommand(enum ur_command_t value, char *buff,
                           const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEventStatus(enum ur_event_status_t value, char *buff,
                               const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEventInfo(enum ur_event_info_t value, char *buff,
                             const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintProfilingInfo(enum ur_profiling_info_t value, char *buff,
                                 const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintExecutionInfo(enum ur_execution_info_t value, char *buff,
                                 const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintMapFlags(enum ur_map_flag_t value, char *buff,
                            const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintExpSamplerMipProperties(
    const struct ur_exp_sampler_mip_properties_t params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintExpInteropSemaphoreDesc(
    const struct ur_exp_interop_semaphore_desc_t params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintExpLayeredImageProperties(
    const struct ur_exp_layered_image_properties_t params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintExpPeerInfo(enum ur_exp_peer_info_t value, char *buff,
                               const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintAdapterGetLastErrorParams(
    const struct ur_adapter_get_last_error_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintBindlessImagesImageFreeExpParams(
    const struct ur_bindless_images_image_free_exp_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintBindlessImagesImageCopyExpParams(
    const struct ur_bindless_images_image_copy_exp_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintCommandBufferCreateExpParams(
    const struct ur_command_buffer_create_exp_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintCommandBufferRetainExpParams(
    const struct ur_command_buffer_retain_exp_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintCommandBufferReleaseExpParams(
    const struct ur_command_buffer_release_exp_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintCommandBufferFinalizeExpParams(
    const struct ur_command_buffer_finalize_exp_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintCommandBufferEnqueueExpParams(
    const struct ur_command_buffer_enqueue_exp_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintContextGetNativeHandleParams(
    const struct ur_context_get_native_handle_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintContextSetExtendedDeleterParams(
    const struct ur_context_set_extended_deleter_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEnqueueKernelLaunchParams(
    const struct ur_enqueue_kernel_launch_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEnqueueEventsWaitParams(
    const struct ur_enqueue_events_wait_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEnqueueMemBufferReadParams(
    const struct ur_enqueue_mem_buffer_read_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEnqueueMemBufferWriteParams(
    const struct ur_enqueue_mem_buffer_write_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEnqueueMemBufferReadRectParams(
    const struct ur_enqueue_mem_buffer_read_rect_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEnqueueMemBufferWriteRectParams(
    const struct ur_enqueue_mem_buffer_write_rect_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEnqueueMemBufferCopyParams(
    const struct ur_enqueue_mem_buffer_copy_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEnqueueMemBufferCopyRectParams(
    const struct ur_enqueue_mem_buffer_copy_rect_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEnqueueMemBufferFillParams(
    const struct ur_enqueue_mem_buffer_fill_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEnqueueMemImageReadParams(
    const struct ur_enqueue_mem_image_read_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEnqueueMemImageWriteParams(
    const struct ur_enqueue_mem_image_write_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEnqueueMemImageCopyParams(
    const struct ur_enqueue_mem_image_copy_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEnqueueMemBufferMapParams(
    const struct ur_enqueue_mem_buffer_map_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEnqueueUsmMemcpyParams(
    const struct ur_enqueue_usm_memcpy_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEnqueueUsmPrefetchParams(
    const struct ur_enqueue_usm_prefetch_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEnqueueUsmAdviseParams(
    const struct ur_enqueue_usm_advise_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEnqueueUsmFill_2dParams(
    const struct ur_enqueue_usm_fill_2d_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEnqueueUsmMemcpy_2dParams(
    const struct ur_enqueue_usm_memcpy_2d_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEnqueueReadHostPipeParams(
    const struct ur_enqueue_read_host_pipe_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEnqueueWriteHostPipeParams(
    const struct ur_enqueue_write_host_pipe_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEventGetProfilingInfoParams(
    const struct ur_event_get_profiling_info_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEventGetNativeHandleParams(
    const struct ur_event_get_native_handle_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintEventSetCallbackParams(
    const struct ur_event_set_callback_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintKernelGetGroupInfoParams(
    const struct ur_kernel_get_group_info_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintKernelGetSubGroupInfoParams(
    const struct ur_kernel_get_sub_group_info_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintKernelGetNativeHandleParams(
    const struct ur_kernel_get_native_handle_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintKernelSetArgValueParams(
    const struct ur_kernel_set_arg_value_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintKernelSetArgLocalParams(
    const struct ur_kernel_set_arg_local_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintKernelSetArgPointerParams(
    const struct ur_kernel_set_arg_pointer_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintKernelSetExecInfoParams(
    const struct ur_kernel_set_exec_info_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintKernelSetArgSamplerParams(
    const struct ur_kernel_set_arg_sampler_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintKernelSetArgMemObjParams(
    const struct ur_kernel_set_arg_mem_obj_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintLoaderConfigCreateParams(
    const struct ur_loader_config_create_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintLoaderConfigRetainParams(
    const struct ur_loader_config_retain_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintLoaderConfigReleaseParams(
    const struct ur_loader_config_release_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintLoaderConfigGetInfoParams(
    const struct ur_loader_config_get_info_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintLoaderConfigEnableLayerParams(
    const struct ur_loader_config_enable_layer_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintMemBufferPartitionParams(
    const struct ur_mem_buffer_partition_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintMemGetNativeHandleParams(
    const struct ur_mem_get_native_handle_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintMemImageGetInfoParams(
    const struct ur_mem_image_get_info_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintPhysicalMemCreateParams(
    const struct ur_physical_mem_create_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintPhysicalMemRetainParams(
    const struct ur_physical_mem_retain_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintPhysicalMemReleaseParams(
    const struct ur_physical_mem_release_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintPlatformGetNativeHandleParams(
    const struct ur_platform_get_native_handle_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintPlatformGetApiVersionParams(
    const struct ur_platform_get_api_version_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintPlatformGetBackendOptionParams(
    const struct ur_platform_get_backend_option_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintProgramCreateWithIlParams(
    const struct ur_program_create_with_il_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintProgramCreateWithBinaryParams(
    const struct ur_program_create_with_binary_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintProgramGetFunctionPointerParams(
    const struct ur_program_get_function_pointer_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintProgramGetBuildInfoParams(
    const struct ur_program_get_build_info_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintProgramGetNativeHandleParams(
    const struct ur_program_get_native_handle_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintQueueGetNativeHandleParams(
    const struct ur_queue_get_native_handle_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintSamplerGetNativeHandleParams(
    const struct ur_sampler_get_native_handle_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintUsmGetMemAllocInfoParams(
    const struct ur_usm_get_mem_alloc_info_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintUsmPitchedAllocExpParams(
    const struct ur_usm_pitched_alloc_exp_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintUsmP2pEnablePeerAccessExpParams(
    const struct ur_usm_p2p_enable_peer_access_exp_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintVirtualMemReserveParams(
    const struct ur_virtual_mem_reserve_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintVirtualMemSetAccessParams(
    const struct ur_virtual_mem_set_access_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintVirtualMemGetInfoParams(
    const struct ur_virtual_mem_get_info_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintDeviceSelectBinaryParams(
    const struct ur_device_select_binary_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintDeviceGetNativeHandleParams(
    const struct ur_device_get_native_handle_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintDeviceGetGlobalTimestampsParams(
    const struct ur_device_get_global_timestamps_params_t *params, char *buff,
    const size_t buff_size, size_t *out_size) {
    if (!buff) {
        return UR_RESULT_ERROR_INVALID_NULL_POINTER;
    }
...
ur_result_t urPrintFunctionParams(enum ur_function_t function,
    ...
    case UR_FUNCTION_ADAPTER_GET: {
        ss << (const struct ur_adapter_get_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ADAPTER_RELEASE: {
        ss << (const struct ur_adapter_release_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ADAPTER_RETAIN: {
        ss << (const struct ur_adapter_retain_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ADAPTER_GET_LAST_ERROR: {
        ss << (const struct ur_adapter_get_last_error_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ADAPTER_GET_INFO: {
        ss << (const struct ur_adapter_get_info_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    ...
    case UR_FUNCTION_BINDLESS_IMAGES_IMAGE_ALLOCATE_EXP: {
        ss << (const struct ur_bindless_images_image_allocate_exp_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_BINDLESS_IMAGES_IMAGE_FREE_EXP: {
        ss << (const struct ur_bindless_images_image_free_exp_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    ...
    case UR_FUNCTION_BINDLESS_IMAGES_SAMPLED_IMAGE_CREATE_EXP: {
        ss << (const struct ur_bindless_images_sampled_image_create_exp_params_t
                   *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_BINDLESS_IMAGES_IMAGE_COPY_EXP: {
        ss << (const struct ur_bindless_images_image_copy_exp_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_BINDLESS_IMAGES_IMAGE_GET_INFO_EXP: {
        ss << (const struct ur_bindless_images_image_get_info_exp_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_BINDLESS_IMAGES_MIPMAP_GET_LEVEL_EXP: {
        ss << (const struct ur_bindless_images_mipmap_get_level_exp_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_BINDLESS_IMAGES_MIPMAP_FREE_EXP: {
        ss << (const struct ur_bindless_images_mipmap_free_exp_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_BINDLESS_IMAGES_IMPORT_OPAQUE_FD_EXP: {
        ss << (const struct ur_bindless_images_import_opaque_fd_exp_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_BINDLESS_IMAGES_MAP_EXTERNAL_ARRAY_EXP: {
        ss << (const struct ur_bindless_images_map_external_array_exp_params_t
                   *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_BINDLESS_IMAGES_RELEASE_INTEROP_EXP: {
        ss << (const struct ur_bindless_images_release_interop_exp_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    ...
    case UR_FUNCTION_COMMAND_BUFFER_CREATE_EXP: {
        ss << (const struct ur_command_buffer_create_exp_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_COMMAND_BUFFER_RETAIN_EXP: {
        ss << (const struct ur_command_buffer_retain_exp_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_COMMAND_BUFFER_RELEASE_EXP: {
        ss << (const struct ur_command_buffer_release_exp_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_COMMAND_BUFFER_FINALIZE_EXP: {
        ss << (const struct ur_command_buffer_finalize_exp_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_COMMAND_BUFFER_APPEND_KERNEL_LAUNCH_EXP: {
        ss << (const struct ur_command_buffer_append_kernel_launch_exp_params_t
                   *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_COMMAND_BUFFER_APPEND_USM_MEMCPY_EXP: {
        ss << (const struct ur_command_buffer_append_usm_memcpy_exp_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_COMMAND_BUFFER_APPEND_USM_FILL_EXP: {
        ss << (const struct ur_command_buffer_append_usm_fill_exp_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    ...
    case UR_FUNCTION_COMMAND_BUFFER_APPEND_USM_PREFETCH_EXP: {
        ss << (const struct ur_command_buffer_append_usm_prefetch_exp_params_t
                   *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_COMMAND_BUFFER_APPEND_USM_ADVISE_EXP: {
        ss << (const struct ur_command_buffer_append_usm_advise_exp_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_COMMAND_BUFFER_ENQUEUE_EXP: {
        ss << (const struct ur_command_buffer_enqueue_exp_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_CONTEXT_CREATE: {
        ss << (const struct ur_context_create_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_CONTEXT_RETAIN: {
        ss << (const struct ur_context_retain_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_CONTEXT_RELEASE: {
        ss << (const struct ur_context_release_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_CONTEXT_GET_INFO: {
        ss << (const struct ur_context_get_info_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_CONTEXT_GET_NATIVE_HANDLE: {
        ss << (const struct ur_context_get_native_handle_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_CONTEXT_CREATE_WITH_NATIVE_HANDLE: {
        ss << (const struct ur_context_create_with_native_handle_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_CONTEXT_SET_EXTENDED_DELETER: {
        ss << (const struct ur_context_set_extended_deleter_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_KERNEL_LAUNCH: {
        ss << (const struct ur_enqueue_kernel_launch_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_EVENTS_WAIT: {
        ss << (const struct ur_enqueue_events_wait_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_EVENTS_WAIT_WITH_BARRIER: {
        ss << (const struct ur_enqueue_events_wait_with_barrier_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_MEM_BUFFER_READ: {
        ss << (const struct ur_enqueue_mem_buffer_read_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_MEM_BUFFER_WRITE: {
        ss << (const struct ur_enqueue_mem_buffer_write_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_MEM_BUFFER_READ_RECT: {
        ss << (const struct ur_enqueue_mem_buffer_read_rect_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_MEM_BUFFER_WRITE_RECT: {
        ss << (const struct ur_enqueue_mem_buffer_write_rect_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_MEM_BUFFER_COPY: {
        ss << (const struct ur_enqueue_mem_buffer_copy_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_MEM_BUFFER_COPY_RECT: {
        ss << (const struct ur_enqueue_mem_buffer_copy_rect_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_MEM_BUFFER_FILL: {
        ss << (const struct ur_enqueue_mem_buffer_fill_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_MEM_IMAGE_READ: {
        ss << (const struct ur_enqueue_mem_image_read_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_MEM_IMAGE_WRITE: {
        ss << (const struct ur_enqueue_mem_image_write_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_MEM_IMAGE_COPY: {
        ss << (const struct ur_enqueue_mem_image_copy_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_MEM_BUFFER_MAP: {
        ss << (const struct ur_enqueue_mem_buffer_map_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_MEM_UNMAP: {
        ss << (const struct ur_enqueue_mem_unmap_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_USM_FILL: {
        ss << (const struct ur_enqueue_usm_fill_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_USM_MEMCPY: {
        ss << (const struct ur_enqueue_usm_memcpy_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_USM_PREFETCH: {
        ss << (const struct ur_enqueue_usm_prefetch_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_USM_ADVISE: {
        ss << (const struct ur_enqueue_usm_advise_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_USM_FILL_2D: {
        ss << (const struct ur_enqueue_usm_fill_2d_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_USM_MEMCPY_2D: {
        ss << (const struct ur_enqueue_usm_memcpy_2d_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_DEVICE_GLOBAL_VARIABLE_WRITE: {
        ss << (const struct ur_enqueue_device_global_variable_write_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_DEVICE_GLOBAL_VARIABLE_READ: {
        ss << (const struct ur_enqueue_device_global_variable_read_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_READ_HOST_PIPE: {
        ss << (const struct ur_enqueue_read_host_pipe_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_WRITE_HOST_PIPE: {
        ss << (const struct ur_enqueue_write_host_pipe_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_ENQUEUE_COOPERATIVE_KERNEL_LAUNCH_EXP: {
        ss << (const struct ur_enqueue_cooperative_kernel_launch_exp_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_EVENT_GET_INFO: {
        ss << (const struct ur_event_get_info_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_EVENT_GET_PROFILING_INFO: {
        ss << (const struct ur_event_get_profiling_info_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_EVENT_WAIT: {
        ss << (const struct ur_event_wait_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_EVENT_RETAIN: {
        ss << (const struct ur_event_retain_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_EVENT_RELEASE: {
        ss << (const struct ur_event_release_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_EVENT_GET_NATIVE_HANDLE: {
        ss << (const struct ur_event_get_native_handle_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_EVENT_CREATE_WITH_NATIVE_HANDLE: {
        ss << (const struct ur_event_create_with_native_handle_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_EVENT_SET_CALLBACK: {
        ss << (const struct ur_event_set_callback_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_KERNEL_CREATE: {
        ss << (const struct ur_kernel_create_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_KERNEL_GET_INFO: {
        ss << (const struct ur_kernel_get_info_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_KERNEL_GET_GROUP_INFO: {
        ss << (const struct ur_kernel_get_group_info_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_KERNEL_GET_SUB_GROUP_INFO: {
        ss << (const struct ur_kernel_get_sub_group_info_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_KERNEL_RETAIN: {
        ss << (const struct ur_kernel_retain_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_KERNEL_RELEASE: {
        ss << (const struct ur_kernel_release_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_KERNEL_GET_NATIVE_HANDLE: {
        ss << (const struct ur_kernel_get_native_handle_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_KERNEL_CREATE_WITH_NATIVE_HANDLE: {
        ss << (const struct ur_kernel_create_with_native_handle_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_KERNEL_SET_ARG_VALUE: {
        ss << (const struct ur_kernel_set_arg_value_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_KERNEL_SET_ARG_LOCAL: {
        ss << (const struct ur_kernel_set_arg_local_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_KERNEL_SET_ARG_POINTER: {
        ss << (const struct ur_kernel_set_arg_pointer_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_KERNEL_SET_EXEC_INFO: {
        ss << (const struct ur_kernel_set_exec_info_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_KERNEL_SET_ARG_SAMPLER: {
        ss << (const struct ur_kernel_set_arg_sampler_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_KERNEL_SET_ARG_MEM_OBJ: {
        ss << (const struct ur_kernel_set_arg_mem_obj_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_KERNEL_SET_SPECIALIZATION_CONSTANTS: {
        ss << (const struct ur_kernel_set_specialization_constants_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    ...
    case UR_FUNCTION_LOADER_INIT: {
        ss << (const struct ur_loader_init_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_LOADER_TEAR_DOWN: {
        ss << (const struct ur_loader_tear_down_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_LOADER_CONFIG_CREATE: {
        ss << (const struct ur_loader_config_create_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_LOADER_CONFIG_RETAIN: {
        ss << (const struct ur_loader_config_retain_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_LOADER_CONFIG_RELEASE: {
        ss << (const struct ur_loader_config_release_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_LOADER_CONFIG_GET_INFO: {
        ss << (const struct ur_loader_config_get_info_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_LOADER_CONFIG_ENABLE_LAYER: {
        ss << (const struct ur_loader_config_enable_layer_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_LOADER_CONFIG_SET_CODE_LOCATION_CALLBACK: {
        ss << (const struct ur_loader_config_set_code_location_callback_params_t
                   *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_MEM_IMAGE_CREATE: {
        ss << (const struct ur_mem_image_create_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_MEM_BUFFER_CREATE: {
        ss << (const struct ur_mem_buffer_create_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_MEM_RETAIN: {
        ss << (const struct ur_mem_retain_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_MEM_RELEASE: {
        ss << (const struct ur_mem_release_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_MEM_BUFFER_PARTITION: {
        ss << (const struct ur_mem_buffer_partition_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_MEM_GET_NATIVE_HANDLE: {
        ss << (const struct ur_mem_get_native_handle_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_MEM_BUFFER_CREATE_WITH_NATIVE_HANDLE: {
        ss << (const struct ur_mem_buffer_create_with_native_handle_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_MEM_IMAGE_CREATE_WITH_NATIVE_HANDLE: {
        ss << (const struct ur_mem_image_create_with_native_handle_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_MEM_GET_INFO: {
        ss << (const struct ur_mem_get_info_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_MEM_IMAGE_GET_INFO: {
        ss << (const struct ur_mem_image_get_info_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PHYSICAL_MEM_CREATE: {
        ss << (const struct ur_physical_mem_create_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PHYSICAL_MEM_RETAIN: {
        ss << (const struct ur_physical_mem_retain_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PHYSICAL_MEM_RELEASE: {
        ss << (const struct ur_physical_mem_release_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PLATFORM_GET: {
        ss << (const struct ur_platform_get_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PLATFORM_GET_INFO: {
        ss << (const struct ur_platform_get_info_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PLATFORM_GET_NATIVE_HANDLE: {
        ss << (const struct ur_platform_get_native_handle_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PLATFORM_CREATE_WITH_NATIVE_HANDLE: {
        ss << (const struct ur_platform_create_with_native_handle_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PLATFORM_GET_API_VERSION: {
        ss << (const struct ur_platform_get_api_version_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PLATFORM_GET_BACKEND_OPTION: {
        ss << (const struct ur_platform_get_backend_option_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PROGRAM_CREATE_WITH_IL: {
        ss << (const struct ur_program_create_with_il_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PROGRAM_CREATE_WITH_BINARY: {
        ss << (const struct ur_program_create_with_binary_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PROGRAM_BUILD: {
        ss << (const struct ur_program_build_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PROGRAM_COMPILE: {
        ss << (const struct ur_program_compile_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PROGRAM_LINK: {
        ss << (const struct ur_program_link_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PROGRAM_RETAIN: {
        ss << (const struct ur_program_retain_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PROGRAM_RELEASE: {
        ss << (const struct ur_program_release_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PROGRAM_GET_FUNCTION_POINTER: {
        ss << (const struct ur_program_get_function_pointer_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PROGRAM_GET_INFO: {
        ss << (const struct ur_program_get_info_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PROGRAM_GET_BUILD_INFO: {
        ss << (const struct ur_program_get_build_info_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PROGRAM_SET_SPECIALIZATION_CONSTANTS: {
        ss << (const struct ur_program_set_specialization_constants_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PROGRAM_GET_NATIVE_HANDLE: {
        ss << (const struct ur_program_get_native_handle_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_PROGRAM_CREATE_WITH_NATIVE_HANDLE: {
        ss << (const struct ur_program_create_with_native_handle_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_QUEUE_GET_INFO: {
        ss << (const struct ur_queue_get_info_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_QUEUE_CREATE: {
        ss << (const struct ur_queue_create_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_QUEUE_RETAIN: {
        ss << (const struct ur_queue_retain_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_QUEUE_RELEASE: {
        ss << (const struct ur_queue_release_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_QUEUE_GET_NATIVE_HANDLE: {
        ss << (const struct ur_queue_get_native_handle_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_QUEUE_CREATE_WITH_NATIVE_HANDLE: {
        ss << (const struct ur_queue_create_with_native_handle_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_QUEUE_FINISH: {
        ss << (const struct ur_queue_finish_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_QUEUE_FLUSH: {
        ss << (const struct ur_queue_flush_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_SAMPLER_CREATE: {
        ss << (const struct ur_sampler_create_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_SAMPLER_RETAIN: {
        ss << (const struct ur_sampler_retain_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_SAMPLER_RELEASE: {
        ss << (const struct ur_sampler_release_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_SAMPLER_GET_INFO: {
        ss << (const struct ur_sampler_get_info_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_SAMPLER_GET_NATIVE_HANDLE: {
        ss << (const struct ur_sampler_get_native_handle_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_SAMPLER_CREATE_WITH_NATIVE_HANDLE: {
        ss << (const struct ur_sampler_create_with_native_handle_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_USM_HOST_ALLOC: {
        ss << (const struct ur_usm_host_alloc_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_USM_DEVICE_ALLOC: {
        ss << (const struct ur_usm_device_alloc_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_USM_SHARED_ALLOC: {
        ss << (const struct ur_usm_shared_alloc_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_USM_FREE: {
        ss << (const struct ur_usm_free_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_USM_GET_MEM_ALLOC_INFO: {
        ss << (const struct ur_usm_get_mem_alloc_info_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_USM_POOL_CREATE: {
        ss << (const struct ur_usm_pool_create_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_USM_POOL_RETAIN: {
        ss << (const struct ur_usm_pool_retain_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_USM_POOL_RELEASE: {
        ss << (const struct ur_usm_pool_release_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_USM_POOL_GET_INFO: {
        ss << (const struct ur_usm_pool_get_info_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_USM_PITCHED_ALLOC_EXP: {
        ss << (const struct ur_usm_pitched_alloc_exp_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_USM_IMPORT_EXP: {
        ss << (const struct ur_usm_import_exp_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_USM_RELEASE_EXP: {
        ss << (const struct ur_usm_release_exp_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_USM_P2P_ENABLE_PEER_ACCESS_EXP: {
        ss << (const struct ur_usm_p2p_enable_peer_access_exp_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_USM_P2P_DISABLE_PEER_ACCESS_EXP: {
        ss << (const struct ur_usm_p2p_disable_peer_access_exp_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_USM_P2P_PEER_ACCESS_GET_INFO_EXP: {
        ss << (const struct ur_usm_p2p_peer_access_get_info_exp_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_VIRTUAL_MEM_GRANULARITY_GET_INFO: {
        ss << (const struct ur_virtual_mem_granularity_get_info_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_VIRTUAL_MEM_RESERVE: {
        ss << (const struct ur_virtual_mem_reserve_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_VIRTUAL_MEM_FREE: {
        ss << (const struct ur_virtual_mem_free_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_VIRTUAL_MEM_MAP: {
        ss << (const struct ur_virtual_mem_map_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_VIRTUAL_MEM_UNMAP: {
        ss << (const struct ur_virtual_mem_unmap_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_VIRTUAL_MEM_SET_ACCESS: {
        ss << (const struct ur_virtual_mem_set_access_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_VIRTUAL_MEM_GET_INFO: {
        ss << (const struct ur_virtual_mem_get_info_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_DEVICE_GET: {
        ss << (const struct ur_device_get_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_DEVICE_GET_INFO: {
        ss << (const struct ur_device_get_info_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_DEVICE_RETAIN: {
        ss << (const struct ur_device_retain_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_DEVICE_RELEASE: {
        ss << (const struct ur_device_release_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_DEVICE_PARTITION: {
        ss << (const struct ur_device_partition_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_DEVICE_SELECT_BINARY: {
        ss << (const struct ur_device_select_binary_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_DEVICE_GET_NATIVE_HANDLE: {
        ss << (const struct ur_device_get_native_handle_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_DEVICE_CREATE_WITH_NATIVE_HANDLE: {
        ss << (const struct ur_device_create_with_native_handle_params_t *)
                params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    case UR_FUNCTION_DEVICE_GET_GLOBAL_TIMESTAMPS: {
        ss << (const struct ur_device_get_global_timestamps_params_t *)params;
        return str_copy(&ss, buff, buff_size, out_size);
    }
    default:
