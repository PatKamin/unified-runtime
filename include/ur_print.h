...
///////////////////////////////////////////////////////////////////////////////
/// @brief Print ur_exp_layered_image_properties_t struct
/// @returns
///     - ::UR_RESULT_SUCCESS
///     - ::UR_RESULT_ERROR_INVALID_NULL_POINTER
///         - `NULL == buffer`
///     - ::UR_RESULT_ERROR_INVALID_SIZE
///         - `buff_size < out_size`
UR_APIEXPORT ur_result_t UR_APICALL urPrintExpLayeredImageProperties(const struct ur_exp_layered_image_properties_t params, char *buffer, const size_t buff_size, size_t *out_size);
